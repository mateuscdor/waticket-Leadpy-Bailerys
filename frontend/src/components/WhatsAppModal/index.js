...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  const [endWorkHour, setEndWorkHour] = useState("12:30");
  const [startWorkHour1, setStartWorkHour1] = useState("14:00");
  const [endWorkHour1, setEndWorkHour1] = useState("18:00");
  ...
  const handleSaveWhatsApp = async (values) => {
    const whatsappData = { ...values, queueIds: selectedQueueIds, 	
      ...
      startWorkHour1: startWorkHour1,
      endWorkHour1: endWorkHour1,
                      ...
                      <>
                        ...
                        <Grid item xs={12} sm={6}>
                          <TextField
                            className={classes.hora}
                            type="time"
                            label={i18n.t("queueModal.form.startWorkHour1")}
                            name="startWorkHour1"
                            value={startWorkHour1}
                            onChange={(e) => setStartWorkHour1(e.target.value)}
                          />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                          <TextField
                            className={classes.hora}
                            type="time"
                            label={i18n.t("queueModal.form.endWorkHour1")}
                            name="endWorkHour1"
                            value={endWorkHour1}
                            onChange={(e) => setEndWorkHour1(e.target.value)}
                          />
                        </Grid>
                      </>
                    ) : (
                      "Estamos fora do nosso horario de atendimento!"
                    )}
                  </Grid>
                  {defineWorkHours === true ? (
                    <>
